...
* **Paige Bailey**:
    * Github: [@DynamicWebPaige](<https://github.com/dynamicwebpaige>)
    * Twitter: [@DynamicWebPaige](<https://twitter.com/dynamicwebpaige>)
* **Wes McKinney**:
    * Github: [@wesm](<https://github.com/wesm>)
    * Twitter: [@wesmckinn](https://twitter.com/wesmckinn)
* **Andreas Mueller**:
    * Github: [@amueller](<https://github.com/amueller>)
    * Twitter: [@amuellerml](<https://twitter.com/amuellerml>)
* **Paul Siame**:
    * Github: [@Pure-Entropy](<https://github.com/Pure-Entropy>)
    * Twitter: [@pure_entropy](<https://twitter.com/pure_entropy>)
* **Alice Goldfuss**:
